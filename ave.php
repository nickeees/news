...
<head>
	...
	<title><?= Yp; ?></title>
	<style>.table-hover tbody tr:hover td{background:black}.table-hover tbody tr:hover td>*{color:#F5FFFA}.table>tbody>tr>*{color:#F5FFFA;vertical-align:middle}.form-control{background:0 0!important;color:#F5FFFA!important;border-radius:0}.form-control::placeholder{color:#F5FFFA;opacity:1}li{font-size:18px;margin-left:6px;list-style:none}a{color:#90EE90}</style>
	<script src="//unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
</head>
<body style="background-color:#DEB887;color:#F5FFFA;font-family:serif;">
